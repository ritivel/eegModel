...
DATA=${EEG_DATA_ROOT:-/opt/dlami/nvme/eeg}/derived/hbn_minimal_500hz
RUNS=${EEG_DATA_ROOT:-/opt/dlami/nvme/eeg}/runs/exp17
LOG=${EEG_DATA_ROOT:-/opt/dlami/nvme/eeg}/scratch/exp17_launch.log
