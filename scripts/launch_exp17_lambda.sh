...
REPO=${REPO:-/home/ubuntu/eegfm}
DATA=${EEG_DATA_ROOT:-/home/ubuntu/data}/hbn_minimal_500hz
RUNS=${EEG_DATA_ROOT:-/home/ubuntu/data}/runs/exp17_mar_mul4
LOG=${EEG_DATA_ROOT:-/home/ubuntu/data}/scratch/exp17_lambda.log
